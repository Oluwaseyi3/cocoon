        ...
        <div className="glass-panel" style={{ padding: '2rem', height: '100%' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                    ...
                    <span style={{ color: 'var(--accent)' }}>+${netProfit.toLocaleString()}.00</span>
                </div>
                <div style={{
                    display: 'flex',
            ...
            <div style={{
                ...
                <p style={{ color: '#fbbf24', fontSize: '0.75rem', lineHeight: '1.4' }}>
                    ...
                    Figures are estimates based on current network demand and A²E arbitrage rates. Actual earnings may vary. No uptime guarantees apply and nodes may experience downtime during alphaTesting when updates or changes to the protocol are being made. Deploying a node involves locking SOL for the duration of the contract.
                </p>
            </div>
        </div>
    );
